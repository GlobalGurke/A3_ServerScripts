...

{
    ...
    // Check if there's a vehicle at the spawn position and delete it
    private _spawnRadius = 4; // Radius to check for existing vehicles
    private _existingVehicles = nearestObjects [_posASL, ["LandVehicle"], _spawnRadius];
    {
        deleteVehicle _x;
