...
_veh_armed addAction ["Toggle Search Light","AL_searchlight\turn_on_off_sl.sqf","",0,false,true,"","",2,false];

while {alive _veh_armed} do 
{
	_veh_armed setVariable ["search_lit_ON",true,true];
	_obiect_dec = "Land_FloodLight_F" createVehiclelocal getpos _veh_armed; _obiect_dec disableCollisionWith _veh_armed; _obiect_dec attachTo [_veh_armed, [0,0,-0.2],_veh_turr_end];
